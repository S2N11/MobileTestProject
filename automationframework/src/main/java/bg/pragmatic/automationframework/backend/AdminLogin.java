...
public class AdminLogin {
	...
	/**
	 * When using this method you will be able to login into the backend of the
	 * ecommerce website
	 * 
	 * @param username
	 *            the username you would like to login with
	 * @param password
	 *            the password you would like to login with
	 */
